jQuery(document).ready(function () {
    ...
    $.ajax({
      ...
      $('#regModalForm').validate({
        rules:{
          nameOfOrg: {required: true},
          natureOfOrg: {required: true},
          addressOfOrg: {required: true},
          telOfOrg: {required: true},
          faxOfOrg: {required: true},
          emailOfOrg: {required: true},
          websiteOfOrg: {required: true},
        ...
        submitHandler: function(){
          ...
          .done(function(data){
            if (data == 'Email sent successfully') {
              ...
              $('.modalFormArea').hide();
              $(".succesfulRegistration").css("display", "block");

            } else if (data == 'Mail not sent') {

              $('.modalFormArea').hide();
              $(".failedRegistration").css("display", "block");
