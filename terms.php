...
<html lang="zxx">
  <head>
    <meta charset="UTF-8">
    <title>
      Country Yellow Pages - Terms of Service
    </title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="about-info">
                ...
                <p>
                  The Country Yellow Pages Nigeria. The A-Z Trade Directory is published in Nigeria by Dionysius Nigeria Enterprises Limited. The company that has made it her duties to publish to the public useful information that will aid business and economy growth of Nigeria in many dimensions.
                </p>
                <p>
                ...
                <p>
                  <span>
                    SUBSCRIPTION IN COUNTRY YELLOW PAGES:
                  </span>
                  Subscriptions in our publication, especially from reputable organizations, companies and professional firms are free without any obligation whatsoever. Moreover, we have some reputable companies and organization, professional bodies and associations in Nigeria that paid for registration.
                </p>
                <p>
                ...
                <p>
                  ...
                  The directory is the sole property of Dionysius Nigeria Enterprises Limited. Should then be any need for reproduction or reprint for any purpose, express permission from the publisher should be obtained. We also enjoy the support of Federal, State and Local Government in this publication. The book can be CUSTOMIZED for your company, Ministries &amp; Parastatals or Agencies, Government, Group of Companies, Association and corporate bodies. Call our G.M Marketing for this purpose.
                </p>
                <p>
                  <span>
                    APPRECIATION:
          ...
          <div class="row">
            ...
            <div class="hidden-sm-down col-md-6 col-lg-6 bg">
              <!-- <img src="images/background/cartoonFlier.jpg" class="img img-responsive bgmain" alt="" width="220px"> -->
              <div id="advertisementCarousel" class="carousel slide bgmain adPage" data-ride="carousel">
